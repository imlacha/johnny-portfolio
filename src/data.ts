...
export const PROJECTS: Record<'zh' | 'en', ProjectItem[]> = {
  zh: [
    ...
    },
    {
      ...
      title: '元件規格自動抽取服務',
      desc: '上傳 Datasheet PDF → Marker 轉換 → 視覺定位 → 雙代理 LLM 自我校準輸出，準確率達 97%。',
      tags: ['FastAPI', 'ocr', 'llm'],
  ...
  en: [
    ...
    },
    {
      dark: false,
      label: 'Datasheet Extractor',
      title: 'Component Spec Auto-Extraction Service',
      desc: 'Upload Datasheet PDF → Marker conversion → Visual localization → Dual-agent LLM self-calibration output, achieving 97% extraction accuracy.',
      tags: ['FastAPI', 'OCR', 'LLM'],
      github: 'https://github.com/imlacha/spec-sheet-extract/tree/main',
      image: datasheetImage,
      delay: true,
